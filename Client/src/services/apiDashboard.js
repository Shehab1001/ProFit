...
export async function getTrainerDashboardPerformanceMetrics(token, filter) {
  ...
  const response = await fetch(
    `http://localhost:4000/api/v1/trainers/Dashboard/performanceMetrics${filterValue}`,
    {
      method: "GET",
      headers: {
...
export async function getTrainerDashboardData(token) {
  const response = await fetch(
    "http://localhost:4000/api/v1/trainers/Dashboard/getDashboardData",
    {
      method: "GET",
      headers: {
        authorization: `Bearer ${token}`,
...
export async function getDashboardTraineesAssessments(token) {
  const response = await fetch(
    "http://localhost:4000/api/v1/trainers/Dashboard/getActiveReadyAssessmentTraineesDashboard",
    {
      method: "GET",
      headers: {
        authorization: `Bearer ${token}`,
...
export async function getAdminDashboardPerformanceMetrics(token, filter) {
  const filterValue = !filter || filter === "All" ? "" : `?days=${filter}`;
  const response = await fetch(
    `http://localhost:4000/api/v1/admin/Dashboard/performanceMetrics${filterValue}`,
    {
      method: "GET",
      headers: {
        authorization: `Bearer ${token}`,
...
export async function getAdminDashboardData(token) {
  const response = await fetch(
    "http://localhost:4000/api/v1/admin/Dashboard/getDashboardData",
    {
      method: "GET",
      headers: {
        authorization: `Bearer ${token}`,
