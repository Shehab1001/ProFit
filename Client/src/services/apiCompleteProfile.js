...
export async function setPersonalInfo(formData, token) {
  const response = await fetch(
    "http://localhost:4000/api/v1/trainers/profile_1",
    {
      method: "PATCH",
      headers: {
...
export async function getPersonalInfo(token) {
  const response = await fetch(
    "http://localhost:4000/api/v1/trainers/TrainerInfo",
    {
      method: "GET",
      headers: {
        authorization: `Bearer ${token}`,
...
export async function getProfileCredentials(token) {
  const response = await fetch(
    "http://localhost:4000/api/v1/trainers/ProfessionalCredentials",
    {
      method: "GET",
      headers: {
        authorization: `Bearer ${token}`,
...
export async function setProfileCredentials(credData, token) {
  const response = await fetch(
    "http://localhost:4000/api/v1/trainers/profile_2",
    {
      method: "PATCH",
      headers: {
...
export async function getQualifications(token) {
  const response = await fetch(
    "http://localhost:4000/api/v1/trainers/qualificationAndAchievement/",
    {
      method: "GET",
      headers: {
        authorization: `Bearer ${token}`,
...
export async function deleteQualification(id, token) {
  const response = await fetch(
    `http://localhost:4000/api/v1/trainers/qualificationAndAchievement/${id}`,
    {
      method: "DELETE",
      headers: {
        authorization: `Bearer ${token}`,
...
export async function getTransformations(token) {
  const response = await fetch(
    "http://localhost:4000/api/v1/trainers/ClientTransformations",
    {
      method: "GET",
      headers: {
        authorization: `Bearer ${token}`,
...
export async function deleteTransformation(id, token) {
  const response = await fetch(
    `http://localhost:4000/api/v1/trainers/ClientTransformations/${id}`,
    {
      method: "DELETE",
      headers: {
        authorization: `Bearer ${token}`,
...
export async function getPackages(token, page) {
  const response = await fetch(
    `http://localhost:4000/api/v1/trainers/packages/?page=${page}&limit=${PAGE_SIZE_DEFAULT}`,
    {
      method: "GET",
      headers: {
        authorization: `Bearer ${token}`,
...
export async function createPackage(packageData, token) {
  const response = await fetch(
    "http://localhost:4000/api/v1/trainers/packages",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
export async function deletePackage(id, token) {
  const response = await fetch(
    `http://localhost:4000/api/v1/trainers/packages/${id}`,
    {
      method: "DELETE",
      headers: {
        authorization: `Bearer ${token}`,
...
export async function submitProfile(submitionData, token) {
  const response = await fetch(
    `http://localhost:4000/api/v1/trainers/submitionrequests`,
    {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
...
export async function getReviews(token) {
  const response = await fetch(
    `http://localhost:4000/api/v1/trainers/AllReviews`,
    {
      method: "GET",
      headers: {
        authorization: `Bearer ${token}`,
